...
public class TraderAccountController {
    ...
    @ApiOperation(value = "Create a trader and an account.",
            notes = "TraderId and accountId are auto generated by database, " +
    ...
    @ApiOperation(value = "Delete a trader",
            notes = "Delete a trader if its account balance is 0 and no associated open positions." +
                    "Also delete the associated accounts and security orders.")
    ...
    public void deleteTrader(@PathVariable Integer traderId) {
        try {
            traderAccountService.deleteTraderId(traderId);
        } catch (Exception e) {
            throw ResponseExceptionUtil.getResponseStatusException(e);
        }
    }
    ...
    @ApiOperation(value = "Deposit a fund",
            notes = "Deposit a fund to the account associated with traderId")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Withdraw a fund",
            notes = "Withdraw fund to the account associated with the traderId.")
    @ApiResponses(value = {
            @ApiResponse(code = 404, message = "TraderId not found."),
            @ApiResponse(code = 400, message = "Unable to withdraw. Incorrect input balance or insufficient balance.")})
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
