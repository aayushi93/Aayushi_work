...
public class JsonParser {
    public static String toJson(Company object, boolean prettyJson, boolean includeNullValues) throws JsonProcessingException {
    ...
    public static <T> T toObjectFromJson(String json, Class cl) throws IOException {
        ObjectMapper m = new ObjectMapper();
